...
namespace VSGDBVsix
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LoadDebugEngineCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("59f79947-34d9-41d9-90a3-2f2342317ee8");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadDebugEngineCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private LoadDebugEngineCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static LoadDebugEngineCommand Instance
        {
            get;
            private set;
        }
